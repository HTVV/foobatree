      ...
      <div class="modal-content">
        <form>
          <div>
            ...
            <div>
              <label><input type="radio" name="gender" value="male" ${datum.data.Gender === 'male' ? 'checked' : ''}><span>male</span></label><br>
              <label><input type="radio" name="gender" value="female" ${datum.data.Gender === 'female' ? 'checked' : ''}><span>female</span></label><br>
            </div>
          </div>
